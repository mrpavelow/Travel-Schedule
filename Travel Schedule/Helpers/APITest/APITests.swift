...
enum APITests {
    ...
    static func testFetchThreadViaSearch() async {
            do {
                ...
                let dto = try JSONDecoder().decode(SearchDTO.self, from: encoded)
    ...
    static func testFetchStationsList() async {
        do {
            ...
            print("✅ stations_list decoded, encoded size: \(encoded.count) bytes")
//            let result = try await service.get()
//            print("✅ Stations list fetched: \(result)")
        } catch {
